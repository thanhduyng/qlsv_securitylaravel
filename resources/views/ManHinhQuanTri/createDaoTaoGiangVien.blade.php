...
<div class="container-fluid py-5">
    <div class="row" style="padding: 20px;margin-top: 15px;">
        <form id="jsthongbao" method="post" action="{{route('quan_tri.storeDaoTaoGiangVien')}}">
            @csrf
            ...
            <div class="row" style="margin-top: 5px;">
                    <div class="col-xs-12">
                        <a style="color: black; font-size: 20px;">Chọn giảng viên</a> <a class="btn-default btn-xs" href=""></a>
                    </div>
                </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="height: 13px; width: 65%;">Tên giảng viên</th>

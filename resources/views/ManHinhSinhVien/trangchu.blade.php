    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width=100% style="height: 110px;">
                    <p style="margin-left: 23px; font-size: 15px;">Lớp: <?php echo \App\qlsv_lophoc::find($value->id_lophoc)->tenlophoc ?></p>
                    <ul style="list-style: none; margin-top: 30px; margin-left: -17px; ">
                        <li style="float: left; margin-right: 3px; "><a class="btn-sm btn-success"  style="padding: 9px 11px; font-size: 13px;"
                        href="/sinh_vien/viewworltask/?id_lophoc={{$value->id_lophoc}}&id_thoikhoabieu={{$value->id_thoikhoabieu}}">Work Task</a></li>
                       
                        <li style="float: left; margin-right: 3px; line-height; "><a class="btn-sm btn-success"  style="padding: 9px 11px; font-size: 13px;"
